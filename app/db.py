...
MIGRATIONS = [
    ...
    "CREATE TABLE IF NOT EXISTS daily_reviews(id INTEGER PRIMARY KEY, user_id INTEGER NOT NULL, date TEXT NOT NULL, note TEXT, mood TEXT, ai_comment TEXT, created TEXT NOT NULL, UNIQUE(user_id, date))",
